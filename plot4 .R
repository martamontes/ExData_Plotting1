...
power_consumptiondataVoltage <- as.numeric(power_consumptiondata$Voltage)
...
par(mfrow=c(2,2))
with(subsetdata, plot(TimeDate, Global_active_power, type="l", xlab=NA, ylab="Global Active Power"))
